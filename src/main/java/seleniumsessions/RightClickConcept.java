...
public class RightClickConcept {
	...
	public static void main(String[] args) {
        ...
        try {
            ...
            List<WebElement> rightClickMenuItems = driver.findElements(By.xpath("//ul[@class='context-menu-list context-menu-root']/li[contains(@class, 'context-menu-icon')]"));
            ...
            for (WebElement menuItem : rightClickMenuItems) {
                ...
                // Optional: Add a short sleep to see the action (not recommended for actual tests)
                Thread.sleep(1000);
            }
